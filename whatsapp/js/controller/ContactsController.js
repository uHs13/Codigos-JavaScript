...
export class ContactsController extends Event {

    constructor(modalEl, firebaseUserInstance) {
        ...
        this.contactListEl = document.querySelector('#contact-list');
    ...
    open() {
        ...
        this.user.getContacts().then(contacts => {
