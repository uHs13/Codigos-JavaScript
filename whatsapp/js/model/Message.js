    ...
    getViewElement(me = true) {
        ...
        switch (this.type) {
            ...
            case 'audio':
                ...
                let btnPlayEl = div.querySelector('.audio-play');
                let btnPauseEl = div.querySelector('.audio-pause');
                let inputRange = div.querySelector('[type=range]');
                let audioDuration = div.querySelector('.message-audio-duration');

                /**
                 * Evento que informa quando os dados
                 * do áudio foram carregados.
                 */
                ...
                audioEl.onpause = e => {
                    ...
                    audioDuration.innerHTML = Format.formatMilliseconds(this.duration * 1000);
                    btnPlayEl.show();
                    btnPauseEl.hide();
                ...
                audioEl.ontimeupdate = e => {
                    ...
                    btnPlayEl.hide();
                    btnPauseEl.hide();
                    audioDuration.innerHTML = Format.formatMilliseconds(audioEl.currentTime * 1000);
